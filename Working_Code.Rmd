...
data %>%
    rename(`First Marking Period` = mp1_perc_oncampus,
           `Second Marking Period` = mp2_perc_oncampus,
           `Third Marking Period` = mp3_perc_oncampus,
           `Fourth Marking Period` = mp4_perc_oncampus)
```
